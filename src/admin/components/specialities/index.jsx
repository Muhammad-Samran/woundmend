				...
				<div className="modal-dialog modal-dialog-centered">
					<div className="modal-content doctor-profile">
						<div className="modal-header">
							<h3 className="mb-0">Invite Doctor</h3>
							...
							<form action="/admin/specialities">
								<div className="add-wrap">
									<div className="form-group form-focus">
										...
										<label className="focus-label">Enter Email<span className="text-danger">*</span></label>
									</div>							
									<div className="submit-section">
										<button type="submit" className="btn btn-primary btn-save">Send</button>
									</div>								
								</div>
							</form>
						</div>
